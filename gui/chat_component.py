...
class ChatComponent(QtWidgets.QWidget):
    ...
    def create_widgets(self):
        ...
        sidebar.setStyleSheet(f"background-color: {self.sidebar_color}; border: 2px solid white;")
        ...
        persona_button_layout.setContentsMargins(0, 0, 0, 0)
        ...
        self.persona_button.setStyleSheet("background-color: transparent; border: none;")
    ...
    def show_settings_frame(self):
        ...
        animation.setEndValue(QtCore.QRect(self.sidebar.width(), 0, 200, self.height()))
        animation.start()

    def hide_settings_frame(self):
        animation = QtCore.QPropertyAnimation(self.settings_frame, b"geometry")
        animation.setDuration(300)
        animation.setStartValue(QtCore.QRect(self.sidebar.width(), 0, 200, self.height()))
