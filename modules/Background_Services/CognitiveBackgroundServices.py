...
logger = logging.getLogger('CognitiveBackgroundServices.py')
...
class CognitiveBackgroundServices:
    ...
    def append_content_by_field(self, user, field_name, content, observations):
        ...
        if field_name in profile:
            ...
            if observations:
                profile[field_name]['obsevations'] = observations
        else:
            profile[field_name] = {"Content": content, "obsevations": observations}
