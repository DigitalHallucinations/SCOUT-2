...
class CodeGeniusUI(QWidget):
    ...
    def setup_ui(self):
        ...
        # Add a label to make it clear this is the CodeGeniusUI
        ...
        self.code_display.setStyleSheet("background-color: #2d2d2d; color: white;")
...
if __name__ == "__main__":
    ...
    window = CodeGeniusUI(interpreter)
    window.show()
    sys.exit(app.exec())